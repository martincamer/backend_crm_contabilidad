...
export const getEstadisticasFecha = async (req, res) => {
  ...
  try {
    ...
    // Consultar en MongoDB los documentos que coincidan con el rango de fechas
    ...
    console.log("Estadísticas encontradas:", estadisticas);
    res.json(estadisticas);
  } catch (error) {
    console.error("Error al obtener estadísticas por año y mes:", error);
    res.status(500).json({ error: "Error interno del servidor" });
  }
};
